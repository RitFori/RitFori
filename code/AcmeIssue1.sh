...
acme.sh --issue --force --dns dns_cf -d $1 --keylength ec-384 --always-force-new-domain-key --log $HOME/acme/log/acme_issue1_$1.log --ca-bundle $curlca --preferred-chain "Root YE"
