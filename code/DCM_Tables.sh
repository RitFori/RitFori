...
#            $2 User password
#            $3 DCM *SYSTEM password
#            $4 Certficate assigned Applications
...
if [[ "$runalready" == '' ]]; then
   db2util "insert into LETABLE values (null, 'MAIN', '$2', current timestamp)"
   db2util "insert into LETABLE values (null, 'SYSTEM', '$3', current timestamp)"
   db2util "insert into LETABLE values ('$1', 'CERTAPP', '$4', current timestamp)"
