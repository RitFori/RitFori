...
3. **Sign On**, **Unzip the repository** to /tmp/ritfori, compile and run **Ritfori SU**. This sets up the user for SSH (required) and sets up the basic environment (Library and Directory structure).
